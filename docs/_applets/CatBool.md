...
- **Predictable reset points:** Because CatBool is fully deterministic, a TR2 reset always returns to the same rhythm. Use RST mode to sync to other sequencers or to drop into a known groove at a section boundary.

---

## Credits

CatBool by Andy Jenkinson / uglifruit, developed with Claude Code (Anthropic).
